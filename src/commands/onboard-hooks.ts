...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.prowl.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("prowl hooks list")}`,
      `  ${formatCliCommand("prowl hooks enable <name>")}`,
      `  ${formatCliCommand("prowl hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
